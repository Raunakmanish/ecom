...
<h3>Farmer Services</h3>
     ...
     <div class="module-body m-t-20">
        <p class="about-us"> A powerful community management platform that supports organizations to identify, profile, collect field data and provide services such as agricultural advisories, credit, insurance to rural folks around India.</p>
        ...
        <ul class="toggle-footer" style="">
            <li class="media">
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <span><a href="#">ratansy0123@gmail.com</a></span>
                </div>
            </li>
