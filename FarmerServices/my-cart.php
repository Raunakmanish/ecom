...
mysqli_query($con,"insert into orders(userId,productId,quantity) values('".$_SESSION['maid']."','$qty','$val34')");
...
// code for billing address updation
	if(isset($_POST['update']))
	{
		...
		$query=mysqli_query($con,"update users set billingAddress='$baddress',billingState='$bstate',billingCity='$bcity',billingPincode='$bpincode' where id='".$_SESSION['maid']."'");
		if($query)
		{
...
// code for Shipping address updation
	if(isset($_POST['shipupdate']))
	{
		...
		$query=mysqli_query($con,"update users set shippingAddress='$saddress',shippingState='$sstate',shippingCity='$scity',shippingPincode='$spincode' where id='".$_SESSION['maid']."'");
		if($query)
		{
				...
				<tr>
					<td colspan="7">
						<div class="shopping-cart-btn">
							<span class="">
								<a href="firstpage.php" class="btn btn-upper btn-primary outer-left-xs">Continue Shopping</a>
...
<?php
$query=mysqli_query($con,"select * from users where id='".$_SESSION['maid']."'");
while($row=mysqli_fetch_array($query))
{
?>
...
<div class="form-group">
 ...
 <div class="form-group">
					    ...
					    <input type="number" pattern="[0-9]{6}" class="form-control unicase-form-control text-input" minlength="6" maxlength="6" id="billingpincode" name="billingpincode" required="required" value="<?php echo $row['billingPincode'];?>" >
					  </div>
