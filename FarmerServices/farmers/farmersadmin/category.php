...
$sql=mysqli_query($con,"insert into farmercategory(categoryName,categoryDescription) values('$category','$description')");
...
if(isset($_GET['del']))
		  {
		          mysqli_query($con,"delete from farmercategory where id = '".$_GET['id']."'");
