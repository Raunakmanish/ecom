...
$sql=mysqli_query($con,"update farmerproducts set category='$category',subCategory='$subcat',productName='$productname',productCompany='$productcompany',productPrice='$productprice',productDescription='$productdescription',shippingCharge='$productscharge',productAvailability='$productavailability',productPriceBeforeDiscount='$productpricebd' where id='$pid' ");
...
$query=mysqli_query($con,"select farmerproducts.*,farmercategory.categoryName as catname,farmercategory.id as cid,farmersucategory.subcategory as subcatname,farmersucategory.id as subcatid from farmerproducts join farmercategory on farmercategory.id=farmerproducts.category join farmersucategory on farmersucategory.id=farmerproducts.subCategory where farmerproducts.id='$pid'");
$cnt=1;
...
<?php $query=mysqli_query($con,"select * from farmercategory");
