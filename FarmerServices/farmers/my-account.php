...
header('location:login.php');
	...
	if(isset($_POST['update']))
	{
		...
		$query=mysqli_query($con,"update users set name='$name',contactno='$contactno' where id='".$_SESSION['fid']."'");
		if($query)
		{
...
{
$sql=mysqli_query($con,"SELECT password FROM  users where password='".$_POST['cpass']."' && id='".$_SESSION['fid']."'");
$num=mysqli_fetch_array($sql);
if($num>0)
{
 $con=mysqli_query($con,"update users set password='".$_POST['newpass']."', updationDate='$currentTime' where id='".$_SESSION['fid']."'");
