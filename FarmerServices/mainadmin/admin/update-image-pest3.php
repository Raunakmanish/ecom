...
if(isset($_POST['submit']))
{
	...
	$sql=mysqli_query($con,"update  medicineproducts set productImage3='$productimage3' where id='$pid' ");
...
$query=mysqli_query($con,"select productName,productImage3 from medicineproducts where id='$pid'");
$cnt=1;
