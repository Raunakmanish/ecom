...
//unlink($dir.'/'.$pimage);
	...
	$sql=mysqli_query($con,"update  medicineproducts set productImage1='$productimage1' where id='$pid' ");
...
$query=mysqli_query($con,"select productName,productImage1 from medicineproducts where id='$pid'");
$cnt=1;
