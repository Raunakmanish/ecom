...
//unlink($dir.'/'.$pimage);
	...
	$sql=mysqli_query($con,"update  medicineproducts set productImage2='$productimage2' where id='$pid' ");
...
$query=mysqli_query($con,"select productName,productImage2 from medicineproducts where id='$pid'");
$cnt=1;
