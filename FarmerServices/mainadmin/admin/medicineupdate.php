...
$query=mysqli_query($con,"insert into medicineordertrackhistory(orderId,status,remark) values('$oid','$status','$remark')");
$sql=mysqli_query($con,"update medicineorders set orderStatus='$status' where id='$oid'");
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <?php 
$ret = mysqli_query($con,"SELECT * FROM medicineordertrackhistory WHERE orderId='$oid'");
   ...
   <?php 
$st='Delivered';
   $rt = mysqli_query($con,"SELECT * FROM medicineorders WHERE id='$oid'");
