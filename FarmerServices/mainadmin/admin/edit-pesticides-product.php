...
$sql=mysqli_query($con,"update  medicineproducts set category='$category',subCategory='$subcat',productName='$productname',productCompany='$productcompany',productPrice='$productprice',productDescription='$productdescription',shippingCharge='$productscharge',productAvailability='$productavailability',productPriceBeforeDiscount='$productpricebd' where id='$pid' ");
...
$query=mysqli_query($con,"select medicineproducts.*,medicinecategory.categoryName as catname,medicinecategory.id as cid,medicinesubcategory.subcategory as subcatname,medicinesubcategory.id as subcatid from medicineproducts join medicinecategory on medicinecategory.id=medicineproducts.category join medicinesubcategory on medicinesubcategory.id=medicineproducts.subCategory where medicineproducts.id='$pid'");
$cnt=1;
...
<?php $query=mysqli_query($con,"select * from medicinecategory");
...
<div class="controls">
<img src="productimages/<?php echo htmlentities($pid);?>/<?php echo htmlentities($row['productImage1']);?>" width="200" height="100"> <a href="update-image-pest1.php?id=<?php echo $row['id'];?>">Change Image</a>
</div>
</div>
...
<div class="controls">
<img src="productimages/<?php echo htmlentities($pid);?>/<?php echo htmlentities($row['productImage2']);?>" width="200" height="100"> <a href="update-image-pest2.php?id=<?php echo $row['id'];?>">Change Image</a>
</div>
</div>
...
<div class="controls">
<img src="productimages/<?php echo htmlentities($pid);?>/<?php echo htmlentities($row['productImage3']);?>" width="200" height="100"> <a href="update-image-pest3.php?id=<?php echo $row['id'];?>">Change Image</a>
</div>
</div>
<?php } ?>
	<div class="control-group">
