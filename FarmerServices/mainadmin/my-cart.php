...
mysqli_query($con,"insert into farmerorders(userId,productId,quantity) values('".$_SESSION['id']."','$qty','$val34')");
...
if(!empty($_SESSION['carts'])){
 ...
 <?php
 $pdtid=array();
    $sql = "SELECT * FROM farmerproducts WHERE id IN(";
			...
			while($row = mysqli_fetch_array($query)){
				$quantity=$_SESSION['carts'][$row['id']]['quantity'];
				$subtotal= $_SESSION['carts'][$row['id']]['quantity']*$row['productPrice']+$row['shippingCharge'];
				$totalprice += $subtotal;
				...
				<tr>
					...
					<td class="cart-image">
						<a class="entry-thumbnail" href="detail.html">
						    <img src="../farmers/farmersadmin/productimages/<?php echo $row['id'];?>/<?php echo $row['productImage1'];?>" alt="" width="114" height="146">
						</a>
					</td>
...
?>
					...
					<td class="cart-product-quantity">
						<div class="quant-input">
				             ...
				             <input type="text" value="<?php echo $_SESSION['carts'][$row['id']]['quantity']; ?>" name="quantity[<?php echo $row['id']; ?>]">
...
<td class="cart-product-sub-total"><span class="cart-sub-total-price"><?php echo "Rs"." ".$row['shippingCharge']; ?>.00</span></td>
					...
					<td class="cart-product-grand-total"><span class="cart-grand-total-price"><?php echo ($_SESSION['carts'][$row['id']]['quantity']*$row['productPrice']+$row['shippingCharge']); ?>.00</span></td>
				</tr>
