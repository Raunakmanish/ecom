...
if(isset($_GET['action']) && $_GET['action']=="add"){
	...
	if(isset($_SESSION['carts'][$id])){
		...
		$sql_p="SELECT * FROM farmerproducts WHERE id={$id}";
		$query_p=mysqli_query($con,$sql_p);
		if(mysqli_num_rows($query_p)!=0){
			$row_p=mysqli_fetch_array($query_p);
			$_SESSION['carts'][$row_p['id']]=array("quantity" => 1, "price" => $row_p['productPrice']);
...
{
mysqli_query($con,"insert into wishlist(userId,productId) values('".$_SESSION['maid']."','$pid')");
...
<?php
$ret=mysqli_query($con,"select farmercategory.categoryName as catname,farmersuCategory.subcategory as subcatname,farmerproducts.productName as pname from farmerproducts join farmercategory on farmercategory.id=farmerproducts.category join farmersucategory on farmersucategory.id=farmerproducts.subCategory where farmerproducts.id='$pid'");
...
<div class="sidebar-widget outer-bottom-xs wow fadeInUp">
	...
	<div class="sidebar-widget-body m-t-10">
		<div class="accordion">
		            ...
		            <?php $sql=mysqli_query($con,"select id,categoryName  from farmercategory");
...
<div class="sidebar-widget hot-deals wow fadeInUp">
	...
	<div class="owl-carousel sidebar-carousel custom-carousel owl-theme outer-top-xs">
								   ...
								   <?php
$ret=mysqli_query($con,"select * from farmerproducts order by rand() limit 4 ");
...
?>
					...
					<div class="products">
						<div class="hot-deal-wrapper">
							<div class="image">
								<img src="../farmers/farmersadmin/productimages/<?php echo htmlentities($rws['id']);?>/<?php echo htmlentities($rws['productImage1']);?>"  width="200" height="334" alt="">
							</div>
...
<?php 
$ret=mysqli_query($con,"select * from farmerproducts where id='$pid'");
    ...
    <div class="product-item-holder size-big single-product-gallery small-gallery">
        ...
        <div id="owl-single-product">
            ...
            <div class="single-product-gallery-item" >
                <a data-lightbox="image-1" data-title="<?php echo htmlentities($row['productName']);?>" href="../farmers/farmersadmin/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage1']);?>">
                    <img class="img-responsive" alt="" src="assets/images/blank.gif" data-echo="../farmers/farmersadmin/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage1']);?>" width="370" height="350" />
                </a>
            </div><!-- /.single-product-gallery-item -->

            <div class="single-product-gallery-item" >
                <a data-lightbox="image-1" data-title="<?php echo htmlentities($row['productName']);?>" href="../farmers/farmersadmin/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage2']);?>">
                    <img class="img-responsive" alt="" src="assets/images/blank.gif" data-echo="../farmers/farmersadmin/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage1']);?>" width="370" height="350" />
                </a>
            </div><!-- /.single-product-gallery-item -->
           ...
           <div class="single-product-gallery-item" >
                <a data-lightbox="image-1" data-title="<?php echo htmlentities($row['productName']);?>" href="../farmers/farmersadmin/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage1']);?>">
                    <img class="img-responsive" alt="" src="assets/images/blank.gif" data-echo="../farmers/farmersadmin/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage3']);?>" width="370" height="350" />
                </a>
            </div>
...
<section class="section featured-product wow fadeInUp">
	...
	<div class="owl-carousel home-owl-carousel upsell-product custom-carousel owl-theme outer-top-xs">
		...
		<?php 
$qry=mysqli_query($con,"select * from farmerproducts where subCategory='$subcid' and category='$cid'");
while($rw=mysqli_fetch_array($qry))
{
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				<a href="product-details.php?pid=<?php echo htmlentities($rw['id']);?>"><img  src="assets/images/blank.gif" data-echo="../farmers/farmersadmin/productimages/<?php echo htmlentities($rw['id']);?>/<?php echo htmlentities($rw['productImage1']);?>" width="150" height="240" alt=""></a>
			</div><!-- /.image -->			
...
function showSlides() {
  var i;
  var slides = document.getElementsByClassName("single-product-gallery-item");
